...
async function fetchHlrLookup(msisdn) {
  const key = process.env.HLR_API_KEY || 'fcd01b61e422';
  const secret = process.env.HLR_API_SECRET || 's7hE-jh43-C4hN-F!49-B!eC-e*7C';
...
const INSTALLMENT_API_URL =
  process.env.INSTALLMENT_API_URL || 'http://scsinfo.pieare.com/securestock/api/installmentprint/inspection/inspect';
